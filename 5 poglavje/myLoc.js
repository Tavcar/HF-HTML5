...
function WatchLocation() {
    watchId = navigator.geolocation.watchPositin(displayLocation, displayError, {timeout:5000});
}
...
function scrollMapToPosition(coords) {
    ...
    addMarker(map, latlong, "Your newlocation", "You moved to: " + latitude + ", " + longitude);
}
